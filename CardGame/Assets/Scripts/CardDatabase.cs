...
public class CardDatabase : MonoSingleton<CardDatabase>
{
    ...
    private void Awake()
    {
        ...
        monsterCardList.Add(new MonsterCard(23, "    ",       70, 20, 45,  1, "每回合为邻位的心魔恢复血量各20点",                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));                                                              
        monsterCardList.Add(new MonsterCard(24, "    ",       70, 20, 45,  1, "每回合为邻位的心魔生成护盾各20点",                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));                                                              
        monsterCardList.Add(new MonsterCard(25, "负隅顽抗",   20, 28, 45,  1, "每回合生成70护甲",                                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));                                                              
        monsterCardList.Add(new MonsterCard(26, "自卑1",      25, 28, 35,  1, "1.每回合生成40护甲\n2.每回合顺时针与间位的心魔互换。",                                                                                   Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
