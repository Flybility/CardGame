...
public class CardDatabase : MonoSingleton<CardDatabase>
{
    ...
    private void Awake()
    {
        ...
        monsterCardList.Add(new MonsterCard(02, "常规(中)",   10,  4,  5,  1, "",                                                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(04, "常规(特大)", 30,  8, 13,  1, "",                                                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(06, "愤怒(大)",   40,  7,  2,  1, "击杀后爆炸,对场上所有心魔均造成50点爆炸伤害,对主角造成15点伤害",                                                                         Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(10, "掮客",        6,  6,  1,  1, "怪物描述2",                                                                                                                              Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(12, "    ",        8,  4,  2,  2, "击杀后下回合常规攻击+15",                                                                                                                Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(14, "无形",        1,  1,  1,  1, "放置后变身成所在位置对位的心魔",                                                                                                         Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(16, "小丑",       25,  8,  5,  1, "每回合末对玩家攻击时施加X层恐惧(X为场上心魔数)",                                                                                         Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(18, "蝙蝠",       16, 14,  5,  1, "1.每回合末对玩家攻击时施加1层恐惧\n2.直接攻击对其无效",                                                                                  Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(20, "炙鬼",       25, 14,  5,  1, "每回合末对玩家攻击时施加2层灼伤",                                                                                                        Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(23, "    ",       70, 20, 45,  1, "每回合为邻位的心魔恢复血量各10点",                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));                                                              
        ...
        monsterCardList.Add(new MonsterCard(25, "负隅顽抗",   20, 28, 45,  1, "每回合生成50护甲",                                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));                                                              
        monsterCardList.Add(new MonsterCard(26, "自卑1",      25, 28, 35,  1, "1.每回合生成30护甲\n2.攻击后顺时针与邻位的心魔互换。",                                                                                   Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        monsterCardList.Add(new MonsterCard(27, "自卑2",      40, 24, 35,  1, "攻击后顺时针与间位的心魔互换",                                                                                                           Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        monsterCardList.Add(new MonsterCard(28, "贪婪1",      10,  4,  0,  1, "回合结束顺时针吞噬血量小于自身当前血量的心魔并累加其回复情绪值及其一半当前生命值\n若其血量大于自身则改变方向",                           Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(30, "    ",       50, 20, 35,  1, "死亡后在场的所有心魔恢复15点血量",                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(32, "孵化者",    160, 33, 70,  1, "在相间位置召唤一对孪生恶魔并覆盖掉原有位置的心魔",                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        monsterCardList.Add(new MonsterCard(33, "孪生恶魔",   10,  4,  0,  1, "1.其中1只死亡时 另1只血量回满,攻击变为20\n每回合攻击后施加3层恐惧并添加12点护甲",                                                        Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(35, "堂吉诃德",   50, 20, 35,  1, "主角情绪上升时'堂吉诃德'血量下降相应的量\n主角情绪下降时'堂吉诃德'血量上升相应的量",                                                     Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        monsterCardList.Add(new MonsterCard(36, "焦虑",       20,  8,  5,  1, "击杀后对相邻的怪物添加两层灼伤",                                                                                                         Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
