...
public class CardDatabase : MonoSingleton<CardDatabase>
{
    ...
    private void Awake()
    {
        ...
        monsterCardList.Add(new MonsterCard(22, "负面本质",   70, 20, 45,  1, "在场上时邻位心魔攻击翻倍",                                                                                                               Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));                                                              
        monsterCardList.Add(new MonsterCard(23, "    ",       70, 20, 45,  1, "每回合为邻位的心魔恢复血量各10点",                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));                                                              
        monsterCardList.Add(new MonsterCard(24, "    ",       70, 20, 45,  1, "每回合为邻位的心魔生成护盾各10点",                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));                                                              
        monsterCardList.Add(new MonsterCard(25, "负隅顽抗",   20, 28, 45,  1, "每回合生成50护甲",                                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));                                                              
        monsterCardList.Add(new MonsterCard(26, "自卑1",      25, 28, 35,  1, "1.每回合生成30护甲\n2.每回合顺时针与邻位的心魔互换。",                                                                                   Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        monsterCardList.Add(new MonsterCard(27, "自卑2",      40, 24, 35,  1, "每回合顺时针与间位的心魔互换",                                                                                                           Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));
        monsterCardList.Add(new MonsterCard(28, "贪婪1",      10,  4,  0,  1, "每回合会顺时针吞噬血量35及以下的相邻位置的心魔并累加他们携带的情绪以及一半生命值和血量\n遇到血量大于35的改变方向",                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));
        monsterCardList.Add(new MonsterCard(29, "贪婪2",      35, 16,  8,  1, "每回合会顺时针吞噬血量小于等于自己的相邻位置的心魔并累加他们携带的情绪以及一半生命值和血量\n遇到血量大于自己的改变方向（先吞噬后攻击）", Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        monsterCardList.Add(new MonsterCard(30, "    ",       50, 20, 35,  1, "死亡后在场的所有心魔恢复15点血量",                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));
        monsterCardList.Add(new MonsterCard(31, "    ",       40, 30, 40,  1, "死亡时仍会对玩家立即造成最后一次伤害",                                                                                                   Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        monsterCardList.Add(new MonsterCard(32, "孵化者",    160, 33, 70,  1, "在相间位置召唤一对孪生恶魔并覆盖掉原有位置的心魔",                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));
        ...
        monsterCardList.Add(new MonsterCard(34, "父亲",       35, 16,  8,  1, "怪物描述3",                                                                                                                              Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(36, "焦虑",       20,  8,  5,  1, "击杀后对相邻的怪物添加两层灼伤",                                                                                                         Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));
