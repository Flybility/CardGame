...
public class CardDatabase : MonoSingleton<CardDatabase>
{
    ...
    private void Awake()
    {
        equipmentCardList.Add(new EquipmentCard(0, "装备名称1", 2, 10, 1, "装备描述1", Resources.Load<Sprite>("CardImages/1"), Resources.Load<Sprite>("CardBackgrounds/1")));
        equipmentCardList.Add(new EquipmentCard(1, "装备名称2", 2, 10, 2, "装备描述2", Resources.Load<Sprite>("CardImages/1"), Resources.Load<Sprite>("CardBackgrounds/2")));
