...
public class CardDatabase : MonoSingleton<CardDatabase>
{
    ...
    private void Awake()
    {
        ...
        monsterCardList.Add(new MonsterCard(27, "自卑2",      40, 24, 35,  1, "攻击后顺时针与间位的心魔互换",                                                                                                           Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));
        monsterCardList.Add(new MonsterCard(28, "贪婪1",      10,  4,  0,  1, "回合结束顺时针吞噬血量小于自身当前血量的心魔并累加其回复情绪值及其一半当前生命值\n若其血量大于自身则改变方向",                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/2")));
