...
public class CardDatabase : MonoSingleton<CardDatabase>
{
    ...
    private void Awake()
    {
        ...
        monsterCardList.Add(new MonsterCard(15, "忍耐",       10,  6,  2,  1, "放置后的3回合内无敌,第3回合结束时爆炸,对相邻心魔造成期间所承受的所有伤害",                                                 Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(24, "顽固",       70, 20, 45,  1, "每回合为邻位的心魔生成护盾各10点",                                                                                                       Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));                                                              
        ...
        monsterCardList.Add(new MonsterCard(26, "自卑1",      25, 28, 35,  1, "1.每回合攻击后生成30护甲并顺时针与邻位的心魔互换。",                                                                                   Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
        ...
        monsterCardList.Add(new MonsterCard(28, "贪婪1",      10,  4,  0,  1, "回合结束顺时针吞噬相邻心魔,若其血量大于自身则改变吞噬方向",                                                                Resources.Load<Sprite>("CardImages/01"), Resources.Load<Sprite>("CardBackgrounds/1")));
